...
export const ROLE_PERMISSIONS: Record<UserRoleName, PermissionLevel> = {
  ...
  brand_customer: {
    level: 5,
    name: "Brand Customer",
    description: "Customer with limited brand access",
    can_access_all_brands: false,
    can_manage_users: false,
    can_manage_brands: false,
    can_view_financials: false,
  ...
  distributor_customer: {
    ...
    description: "Customer with limited distributor access",
    can_access_all_brands: false,
    can_manage_users: false,
    can_manage_brands: false,
    can_view_financials: false,
  ...
  manufacturer_customer: {
    level: 5,
    name: "Manufacturer Customer",
    description: "Customer with limited manufacturer access",
    can_access_all_brands: false,
    can_manage_users: false,
    can_manage_brands: false,
    can_view_financials: false,
