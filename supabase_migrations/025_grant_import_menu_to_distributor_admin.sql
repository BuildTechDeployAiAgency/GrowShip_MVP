-- ================================================
-- MIGRATION 025: GRANT IMPORT MENU TO DISTRIBUTOR ADMIN
-- ================================================
-- Description: Grant distributor_admin role permission to view the Import menu
-- Date: January 13, 2025
-- Author: GrowShip MVP Team
-- ================================================

-- Grant import menu permission to distributor_admin role
INSERT INTO role_menu_permissions (role_id, menu_id, can_view, can_edit, can_delete, can_approve, created_at)
SELECT 
  r.id as role_id,
  m.id as menu_id,
  true as can_view,
  true as can_edit,  -- Allow distributor admins to import/edit
  false as can_delete,
