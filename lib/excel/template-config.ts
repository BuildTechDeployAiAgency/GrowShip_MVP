...
export const ORDER_TEMPLATE_FIELDS: TemplateFieldConfig[] = [
  ...
  },
  {
    ...
    isRequired: true,
    dataType: "string",
    description: "Distributor UUID (leave empty if you are a distributor)",
...
export const ORDER_TEMPLATE_CONFIG: TemplateConfig = {
  ...
  instructions: [
    "1. Fill in all REQUIRED fields (Order Date, Customer Name, SKU, Quantity, Unit Price, Distributor ID)",
    "2. All SKUs must exist in your products catalog and be active",
    "3. For multiple items in one order, use the same Order Date and Customer Name on consecutive rows",
    "4. Dates can be in formats: YYYY-MM-DD, MM/DD/YYYY, or DD-MM-YYYY",
    "5. Numbers should not contain currency symbols or commas",
    "6. Distributor ID can be left empty if you are a distributor user",
